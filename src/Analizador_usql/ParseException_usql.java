/* Generated By:JavaCC: Do not edit this line. ParseException_usql.java Version 5.0 */
 ...
 */
public class ParseException_usql extends Exception {
  ...
  /**
     ...
     * "tokenImage" set.
   */
  public ParseException_usql(Token currentTokenVal,
  ...
  public ParseException_usql() {
     ...
     */
  public ParseException_usql(String message) {
    super(message);
  }
  ...
  public String[] tokenImage;
    ...
    public String mensaje() {
        ...
        texto.append("Error sintactico en la entrada...");
        for (int i = 0; i < expectedTokenSequences.length; i++) {
            for (int j = 0; j < expectedTokenSequences[i].length; j++) {
                texto.append(tokenImage[expectedTokenSequences[i][j]]);
            }
...
/* JavaCC - OriginalChecksum=fb48eb884104e45d83e68757bada5d72 (do not edit this line) */
